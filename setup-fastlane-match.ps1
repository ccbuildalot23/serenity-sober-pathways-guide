...
Write-Host "1️⃣ Match Password" -ForegroundColor Cyan
...
Set-GitHubSecretInteractive -SecretName "MATCH_PASSWORD" -Prompt "Enter Match encryption password:" -IsPassword $true

# Step 2: GitHub Personal Access Token for Match
Write-Host ""
Write-Host "2️⃣ GitHub Personal Access Token" -ForegroundColor Cyan
...
# Step 3: Apple ID
Write-Host ""
Write-Host "3️⃣ Apple Developer Account" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "4️⃣ App-Specific Password" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "5️⃣ Match Keychain Password (Optional)" -ForegroundColor Cyan
...
if ($useCustomKeychain -eq "y") {
    Set-GitHubSecretInteractive -SecretName "MATCH_KEYCHAIN_PASSWORD" -Prompt "Enter keychain password:" -IsPassword $true
}

# Use existing App Store Connect API credentials
Write-Host ""
Write-Host "6️⃣ Using Existing App Store Connect API Credentials" -ForegroundColor Cyan
