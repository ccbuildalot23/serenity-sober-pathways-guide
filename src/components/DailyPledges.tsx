        ...
        <TabsContent value="templates">
          <Card>
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Pre-written commitments and prompts to inspire your daily practice.
              </p>
            </CardHeader>
            <CardContent>
                ...
                {templates.map((template) => (
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground mb-3">
                      <p><strong>Morning:</strong> {template.morning_prompt}</p>
                      <p><strong>Evening:</strong> {template.evening_prompt}</p>
                    </div>
