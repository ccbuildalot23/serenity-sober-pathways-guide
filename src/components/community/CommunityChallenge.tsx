      ...
      const mockChallenges: CommunityChallenge[] = [
        {
          ...
          description: 'Practice mindfulness for 10 minutes each day for 30 days',
        ...
        },
        {
          ...
          description: 'Complete your daily check-in 7 days in a row',
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="flex items-center gap-1">
                      ...
                      Goal: {challenge.goal_target} days
                    </span>
