          ...
          <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Info className="w-4 h-4 text-blue-600 cursor-help" aria-label="What are PHQ-2 and GAD-2?" />
              </TooltipTrigger>
              <TooltipContent>
                PHQ-2 screens for depression and GAD-2 screens for anxiety. Your answers help track changes over time.
              </TooltipContent>
            </Tooltip>
          </h3>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Info className="inline w-3 h-3 ml-1 text-blue-600 cursor-help" aria-label="This question is part of the PHQ-2 depression screen" />
                    </TooltipTrigger>
                    <TooltipContent>Part of the PHQ-2 depression screen.</TooltipContent>
                  </Tooltip>
                </label>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Info className="inline w-3 h-3 ml-1 text-blue-600 cursor-help" aria-label="This question is part of the GAD-2 anxiety screen" />
                    </TooltipTrigger>
                    <TooltipContent>Part of the GAD-2 anxiety screen.</TooltipContent>
                  </Tooltip>
                </label>
                <div className="space-y-2">
                  {assessmentOptions.map((option) => (
