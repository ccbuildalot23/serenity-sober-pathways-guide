...
type CarouselProps = {
  _opts?: CarouselOptions
  _plugins?: CarouselPlugin
...
function useCarousel() {
  const context = React.useContext(_CarouselContext)
...
>(
  (
    ...
    const [canScrollPrev, setCanScrollPrev] = React.useState(_false)
    const [canScrollNext, setCanScrollNext] = React.useState(_false)
    ...
    return (
      <_CarouselContext.Provider
        value={{
          ...
          _opts,
          orientation:
            orientation || (_opts?._axis === "y" ? "vertical" : "horizontal"),
          scrollPrev,
          scrollNext,
          canScrollPrev,
          canScrollNext,
