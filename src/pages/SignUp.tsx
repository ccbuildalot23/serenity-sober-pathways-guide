      ...
      <div className="flex items-center justify-center px-4 py-16">
        ...
        >
          <GlassCard className="p-8 bg-white/90 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Redirecting to Signup</h2>
            <p className="text-gray-600">Taking you to our secure registration page...</p>
            <div className="mt-4 w-8 h-8 animate-spin mx-auto border-2 border-emerald-600 border-t-transparent rounded-full" />
          </GlassCard>
        </motion.div>
      </div>
    </div>
